      ...
      <div className="border-t pt-4 mt-auto">
        ...
        <div className="flex gap-4 items-center">
          <button
            ...
            className="w-full py-2 px-4 rounded-md font-medium transition-colors bg-black text-white hover:bg-gray-800"
          >
            Изменить
          </button>
          <button
            onClick={() => addToCart(product)}
            className="w-full py-2 px-4 rounded-md font-medium transition-colors bg-red-500 text-white hover:bg-red-400"
          >
            Удалить
          </button>
        </div>
